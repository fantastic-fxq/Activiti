package com.dynamic.exclusiveGateWay;
...
public class exclusiveGateWayTest {
	...
	public void deploymentProcessDifinition_inputStream() {
		...
		Deployment deployment = processEngine.getRepositoryService()
				...
				.addInputStream("exclusiveGateWay.png", inputStreampng).name("排他网关")
				.deploy();
...
//	完成当前人任务
	...
	public void completeCurrentPersonTask()
	{
		...
		processEngine.getTaskService().complete(taskId,variables);//正在执行任务管理相关的Service
